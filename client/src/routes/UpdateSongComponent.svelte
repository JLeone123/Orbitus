  ...
  <div class="modal-dialog modal-lg">
        ...
        <div class="row g-2">
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-song-name-input" placeholder="Song name" aria-label="Song name" aria-describedby="u-song-name-icon" required>
          ...
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-artist-name-input" placeholder="Artist name" aria-label="Artist name" aria-describedby="u-artist-name-icon" required>
        ...
        <div class="row g-2">
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-mp3-file-input" placeholder="MP3 File" aria-label="MP3 file" aria-describedby="u-mp3-file-input" required>
          ...
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-image-artwork-input" placeholder="Image artwork" aria-label="Image artwork" aria-describedby="u-image-artwork-input" required>
        ...
        <div class="row g-2">
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-song-positivity-score" placeholder="Positivity" aria-label="Positivity" aria-describedby="u-song-positivity-score" required>
          ...
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-song-energy-score" placeholder="Energy" aria-label="Energy" aria-describedby="u-song-energy-score" required>
        ...
        <div class="row g-2">
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-song-rhythm-score" placeholder="Rhythm" aria-label="Rhythm" aria-describedby="u-song-rhythm-score" required>
          ...
          <div class="col-md">
            <div class="input-group mb-3">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" id="u-song-liveliness-score" placeholder="liveliness" aria-label="liveliness" aria-describedby="u-song-liveliness-score" required>
    ...
    <!-- Modal footer and submit button -->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" on:click={handleUpdateForm}>Save changes</button>
      </div>
    </div>
  </div>
</div>