export const getFilePaths = (songObject, relativeImagePath, relativeMp3Path, imgStore, audioStore) => {
    ...
    if (mp3FileToUse === undefined) {
        mp3FileToUse = ["songDefault","/src/lib/assets/stored_songs/indie/early-hours-justin-lee-main-version-21967-01-54.mp3"];
    }
