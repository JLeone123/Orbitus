  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="input-group mb-3">
          ...
          <div class="form-floating">
            <input type="text" class="form-control" id="d-song-name-input" placeholder="Song name" aria-label="Song name" aria-describedby="d-song-name-input" required>
        ...
        <div class="input-group mb-3">
          ...
          <div class="form-floating">
            <input type="text" class="form-control" id="d-artist-name-input" placeholder="Artist name" aria-label="Song name" aria-describedby="d-artist-name-input" required>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" on:click={handleDeleteForm}>Save changes</button>
      </div>
    </div>
  </div>
</div>