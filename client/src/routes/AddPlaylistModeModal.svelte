<script>
    ...
    const addPlaylistMode = async () => {
        ...
        if (newModeName === undefined || typeof newModeName !== "string" || newModeName.trim().length === 0) {
            console.log('New mode name is not a valid name');
            return;
        }

        if (positivityScore === undefined || typeof positivityScore !== "number" || 
            positivityScore < 0 || positivityScore > 100) {
            console.log('Positivity score is not a valid number');
            return;
        }

        if (energyScore === undefined || typeof energyScore !== "number" || 
            energyScore < 0 || energyScore > 100) {
            console.log('Energy score is not a valid number');
            return;
        }

        if (rhythmScore === undefined || typeof rhythmScore !== "number" || 
            rhythmScore < 0 || rhythmScore > 100) {
            console.log('Rhythm score is not a valid number');
            return;
        }

        if (livelinessScore === undefined || typeof livelinessScore !== "number" || 
            livelinessScore < 0 || livelinessScore > 100) {
            console.log('liveliness score is not a valid number');
            return;
        }

        if (positivitySign !== ">" && positivitySign !== ">=" &&
            positivitySign !== "<" && positivitySign !== "<=") {
                console.log("The positivity sign is not >, >=, <, or <=");
                return;
        }

        if (energySign !== ">" && energySign !== ">=" &&
            energySign !== "<" && energySign !== "<=") {
                console.log("The energy sign is not >, >=, <, or <=");
                return;
        }

        if (rhythmSign !== ">" && rhythmSign !== ">=" &&
            rhythmSign !== "<" && rhythmSign !== "<=") {
                console.log("The rhythm sign is not >, >=, <, or <=");
                return;
        }

        if (livelinessSign !== ">" && livelinessSign !== ">=" &&
            livelinessSign !== "<" && livelinessSign !== "<=") {
        ...
        let event = {
            event: {
                type: 'ModeCreated',
                data: {
                    newModeName, positivityScore, energyScore, 
                    rhythmScore, livelinessScore, positivitySign, 
                    energySign, rhythmSign, livelinessSign
                }
            }
        }
...
<div class="modal fade" id="addPlaylistModeModal" tabindex="-1" aria-labelledby="addPlaylistModeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="input-group mb-3">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="m-new-mode-name" placeholder="(e.g Playlist One)" aria-label="(e.g. Playlist One)" aria-describedby="m-new-mode-name" required>
          ...
          <div class="row g-2">
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-positivity-score" placeholder="Positivity (e.g. 90.4, 50.3, 30.2)" aria-label="Positivity (e.g. 90.4, 50.3, 30.2)" aria-describedby="m-positivity-score" required>
            ...
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-positivity-sign" placeholder="e.g. >=" aria-label="Positivity (e.g. 90.4, 50.3, 30.2)" aria-describedby="m-positivity-sign" required>
          ...
          <div class="row g-2">
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-energy-score" placeholder="Energy (e.g. 90.4, 50.3, 30.2)" aria-label="Energy (e.g. 90.4, 50.3, 30.2)" aria-describedby="m-energy-score" required>
            ...
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-energy-sign" placeholder="(e.g. >=)" aria-label="(e.g. >=)" aria-describedby="m-energy-sign" required>
          ...
          <div class="row g-2">
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-rhythm-score" placeholder="liveliness (e.g. 90.4, 50.3, 30.2)" aria-label="Positivity (e.g. 90.4, 50.3, 30.2)" aria-describedby="m-rhythm-score" required>
            ...
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-rhythm-sign" placeholder="(e.g. >=)" aria-label="(e.g. >=)" aria-describedby="m-rhythm-sign" required>
          ...
          <div class="row g-2">
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-liveliness-score" placeholder="liveliness (e.g. 90.4, 50.3, 30.2)" aria-label="liveliness (e.g. 90.4, 50.3, 30.2)" aria-describedby="m-liveliness-score" required>
            ...
            <div class="col-md">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="m-liveliness-sign" placeholder="(e.g >=)" aria-label="(e.g. >=)" aria-describedby="m-liveliness-sign" required>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" data-bs-dismiss="modal" on:click={addPlaylistMode}>Save changes</button>
        </div>
      </div>
    </div>
  </div>