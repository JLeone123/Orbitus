...
export const checkEvent = (e, t, d, r) => {
  ...
  if (t === undefined || d === undefined) {
    logger.error(
      "EventType Error: The event, event-type, and event-data must be defined"
    );
    r.status(400).send({
      msg: "The event, event-type, and event-data must be defined",
    });
    return false;
  }
  ...
  if (r === undefined) {
    logger.error(
      "EventType Error: The HTTP response must be passed to the checkEvent function"
    );
    r.status(400).send({
      msg: "The HTTP response must be passed to the checkEvent function",
    });
    return false;
  }
  ...
  if (typeof e !== "object" || typeof t !== "string" || typeof d !== "object") {
    logger.error(
      "EventType Error: The event, event-type, and event-data must be object types"
    );
    r.status(400).send({
      msg: "The event, event-type, and event-data must be object types",
    });
    return false;
  }
  ...
  if (t === "ModeGenerated") {
    if (
      ...
      typeof d.newModeName !== "string" ||
      d.newModeName.trim().length === 0
    ) {
  ...
  if (t === "ModeCreated" || t === "ModeGenerated") {
    if (
      d.positivityScore === undefined ||
      typeof d.positivityScore !== "number" ||
      d.positivityScore < 0 ||
      d.positivityScore > 100
    ) {
    ...
    if (
      d.energyScore === undefined ||
      typeof d.energyScore !== "number" ||
      d.energyScore < 0 ||
      d.energyScore > 100
    ) {
    ...
    if (
      d.rhythmScore === undefined ||
      typeof d.rhythmScore !== "number" ||
      d.rhythmScore < 0 ||
      d.rhythmScore > 100
    ) {
    ...
    if (
      d.livelinessScore === undefined ||
      typeof d.livelinessScore !== "number" ||
      d.livelinessScore < 0 ||
      d.livelinessScore > 100
    ) {
    ...
    if (
      d.positivitySign === undefined ||
      typeof d.positivitySign !== "string" ||
      (d.positivitySign !== ">" &&
        d.positivitySign !== ">=" &&
        d.positivitySign !== "<" &&
        d.positivitySign !== "<=")
    ...
    if (
      d.energySign === undefined ||
      typeof d.energySign !== "string" ||
      (d.energySign !== ">" &&
        d.energySign !== ">=" &&
        d.energySign !== "<" &&
        d.energySign !== "<=")
    ...
    if (
      d.rhythmSign === undefined ||
      typeof d.rhythmSign !== "string" ||
      (d.rhythmSign !== ">" &&
        d.rhythmSign !== ">=" &&
        d.rhythmSign !== "<" &&
        d.rhythmSign !== "<=")
    ...
    if (
      d.livelinessSign === undefined ||
      typeof d.livelinessSign !== "string" ||
      (d.livelinessSign !== ">" &&
        d.livelinessSign !== ">=" &&
        d.livelinessSign !== "<" &&
        d.livelinessSign !== "<=")
  ...
  if (t === "SongDeleted") {
    if (
      d.songName === undefined ||
      typeof d.songName !== "string" ||
      d.songName.trim().length === 0
    ) {
    ...
    if (
      d.artistName === undefined ||
      typeof d.artistName !== "string" ||
      d.artistName.trim().length === 0
    ) {
  ...
  if (t === "SongCreated" || t === "SongUpdated") {
    ...
    if (
      d.imageArt === undefined ||
      typeof d.imageArt !== "string" ||
      d.imageArt.trim().length === 0
    ) {
    ...
    if (
      d.positivity === undefined ||
      typeof d.positivity !== "number" ||
      d.positivity < 0 ||
      d.positivity > 100
    ) {
      logger.error(
        "EventType Error: Please provide a song positivity score between 0 and 100"
      );
      r.status(400).send({
        msg: "Please provide a song positivity score between 0 and 100",
      });
      return false;
    }
    ...
    if (
      ...
      logger.error(
        "EventType Error: Please provide a song energy score between 0 and 100"
      );
      r.status(400).send({
        msg: "Please provide a song energy score between 0 and 100",
      });
      return false;
    }
    ...
    if (
      d.rhythm === undefined ||
      typeof d.rhythm !== "number" ||
      d.rhythm < 0 ||
      d.rhythm > 100
    ) {
      logger.error(
        "EventType Error: Please provide a song rhythm score between 0 and 100"
      );
      r.status(400).send({
        msg: "Please provide a song rhythm score between 0 and 100",
      });
      return false;
    }

    if (
      d.liveliness === undefined ||
      typeof d.liveliness !== "number" ||
      d.liveliness < 0 ||
      d.liveliness > 100
    ) {
      logger.error(
        "EventType Error: Please provide a song liveliness score between 0 and 100"
      );
      r.status(400).send({
        msg: "Please provide a song liveliness score between 0 and 100",
      });
      return false;
    }
  }
