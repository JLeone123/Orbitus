    ...
    return {
        init: async () => {
            ...
            for (let i = 0; i < modeList.length; ++i) {
                ...
                let v = [name, positivityScore, energyScore, rhythmScore, livelinessScore, positivitySign, energySign, rhythmSign, livelinessSign];

                currentInsert = "INSERT INTO modes" +
        ...
        /** CREATE Operations */
        createMode: async (newModeName, pScore, eScore, rScore, vScore, pSign, eSign, rSign, vSign) => {
            // let queryTextOne = 'select * from modes where'

            let queryTextTwo = 'insert into modes(name, positivity, energy, rhythm, liveliness, ' +
                               'positivity_sign, energy_sign, rhythm_sign, liveliness_sign) ' +

                               'values ($1, $2, $3, $4, $5, $6, $7, $8, $9) returning *;';
            let v = [newModeName, pScore, eScore, rScore, vScore, pSign, eSign, rSign, vSign];
